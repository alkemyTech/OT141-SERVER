const createEmailHtml = (firstName) => {
                          ...
                          <tbody>
                            <tr>
                              <td style="width:312px;">
                                ...
                                <img height="auto"
                                  src="https://res.cloudinary.com/dosugr8hb/image/upload/v1645733990/ong_logo_ixvsqv.png"
                      ...
                      <td align="left" style="font-size:0px;padding:15px 15px 15px 15px;word-break:break-word;">
                        ...
                        <div
                          ...
                          <p style="text-align: center;"><span
                              style="font-size: 24px;"><strong>¡Hola ${firstName}!, Bienvenido a Somos Más</strong></span></p>
                          <p style="text-align: center;">&nbsp;</p>
                          <p style="text-align: center;"><span style="font-size: 16px;">Tu cuenta ha sido registrada correctamente</span></p>
                        </div>
